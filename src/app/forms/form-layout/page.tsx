          ...
          <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
            ...
            <form onSubmit={handleSubmit}>
              <div className="p-6.5">
                ...
                <SelectGroupFour selectedOptionFour={selectedOptionFour} setSelectedOptionFour={setSelectedOptionFour} />
                ...
                <SelectGroupOne selectedOptionOne={selectedOptionOne} setSelectedOptionOne={setSelectedOptionOne}  />
                <SelectGroupThree  selectedOptionThree={selectedOptionThree} setSelectedOptionThree={setSelectedOptionThree} />
