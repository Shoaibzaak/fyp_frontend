...
interface SelectGroupOneProps {
  ...
  setSelectedOptionOne: (value: string) => void;
}
...
const SelectGroupOne: React.FC<SelectGroupOneProps> = ({
  ...
  return (
    <div className="mb-4.5">
      <label className="mb-2.5 block text-black dark:text-white">Education</label>
      ...
      <div className="relative z-20 bg-transparent dark:bg-form-input">
        ...
        >
          ...
          <option value="Master" className="text-body dark:text-bodydark">
            Master
          </option>
          <option value="Bachelor" className="text-body dark:text-bodydark">
            Bachelor
          </option>
