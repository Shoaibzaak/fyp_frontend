...
interface SelectGroupThreeProps {
  ...
  setSelectedOptionThree: (value: string) => void;
}

const SelectGroupThree: React.FC<SelectGroupThreeProps> = ({
  selectedOptionThree,
    ...
    <div className="mb-4.5">
      ...
      <div className="relative z-20 bg-transparent dark:bg-form-input">
        ...
        >
          ...
          <option value="Banking" className="text-body dark:text-bodydark">
            Banking
          </option>
          <option value="Education" className="text-body dark:text-bodydark">
            Education
          </option>
          <option value="Telecommunication" className="text-body dark:text-bodydark">
            Telecommunication
          </option>
